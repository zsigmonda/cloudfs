...

{
    ...
    DbgPrint("CloudFS!CloudFSInstanceSetup: Entered\n");
...
)
{
	...
	/*
	DbgPrint("CloudFS!CloudFSPreCreate: Entered\n");
	...
	if (FltObjects != NULL)
	{
		if (FltObjects->FileObject != NULL)
		{
			...
			DbgPrint("File affected: %wZ", &fileName);
		}
	}
	*/
...
)
{
	...
	//DbgPrint("CloudFS!CloudFSPostCreate: Entered\n");
